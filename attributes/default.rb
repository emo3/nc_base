default['nc_base'].tap do |ncb|
  ...
  ncb['install_dir'] = "#{Chef::Config[:file_cache_path]}/nco81"
  ncb['fp_dir']      = "#{Chef::Config[:file_cache_path]}/nco81fp"
  ncb['gate_dir']    = "#{Chef::Config[:file_cache_path]}/gateways"
  ncb['nckl_dir']    = "#{Chef::Config[:file_cache_path]}/nckl"
  ncb['temp_dir']    = '/tmp'
  ncb['prs_dir']     = "#{Chef::Config[:file_cache_path]}/prs"
  ncb['im_dir']      = "#{Chef::Config[:file_cache_path]}/im"
